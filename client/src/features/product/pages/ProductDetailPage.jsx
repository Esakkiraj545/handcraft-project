            ...
            <div className="mb-10">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div className="flex items-center text-[#C5A059]">
                  ...
                  <span className="ml-1.5 text-xs font-bold text-[#1F1F1F]/60">4.9 (128 reviews)</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 mb-8">
                ...
                <div className="flex items-center space-x-4 bg-[#FDFBF7] rounded-full p-1 border border-[#EFE9DF]">
                  <button 
                    ...
                    className="w-10 h-10 flex items-center justify-center text-[#1F1F1F] hover:bg-white hover:text-[#C5A059] rounded-full transition-all shadow-sm"
                  >
                    <Minus size={16} />
                  </button>
